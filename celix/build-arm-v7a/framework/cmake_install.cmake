...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "framework")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/home/marcojansen/workspace/crosscompiling/celix/build-arm-v7a/framework/libcelix_framework.so")
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "framework")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/celix" TYPE FILE FILES
    ...
    "/home/marcojansen/workspace/crosscompiling/celix/build-arm-v7a/config.h"
    )
endif()
